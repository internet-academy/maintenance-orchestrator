...
- **customer.AttendanceCertificate**: `[update_time, date_of_issue, customer, name, enrollment_start, enrollment_end, course_name, attendance_records]`
...
- **customer.CourseCompletionCertificate**: `[update_time, date_of_issue, customer, kana, name, zipcode, address, course_name]`
- **customer.CreditCertificate**: `[update_time, date_of_issue, customer, name, date_of_birth, course_name, training_start, training_end]`
...
- **bohr/apps/contest/models.py**: Error: 504 Deadline Exceeded
